...
class MFFAQChatbot:
    def __init__(self, db_path='vector_db'):
        ...
        if not api_key:
            print("Warning: GROQ_API_KEY not found in environment. Please check your .env file.")
        self.client = Groq(api_key=api_key or "DUMMY_KEY")
...
"""
    ...
    def generate_response(self, query):
        ...
        # 2. Performance/Advice Rejection
        advice_keywords = ["best fund", "should i invest", "give me advice", "top performers", "highest return", "recommend"]
        ...
        # Post-processing: Append Footer if missing
